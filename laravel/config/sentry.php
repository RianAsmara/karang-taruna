...
return [
    ...
    //
    // Hard-coded false, not env-configurable: this app stores members'
    // names, phone numbers and payment history. Enabling PII would ship
    // request bodies and user identities to a third-party processor, which
    // is a data-protection decision (UU PDP 27/2022), not an ops toggle.
    // A Sentry event here should carry the stack trace and nothing about
    // who triggered it.
