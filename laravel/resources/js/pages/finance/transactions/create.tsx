...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Transaksi', href: '/finance/transactions/create' },
];

export default function TransactionsCreate({ accounts, categories, events, transactionTypes }: TransactionFormProps) {
